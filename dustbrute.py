...
def function(email,passw,i):
	...
	if 'Find Friends' in r.text or 'Two-factor authentication required' in r.text or 'security code' in r.text or "Log Out" in r.text or "Log In With One Tap" in r.text:
